  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Trading platform specific variants
        trade: "bg-gradient-primary text-white hover:shadow-glow transition-all duration-300 shadow-lg",
        ...
        community: "bg-gradient-secondary text-white hover:shadow-lg transition-all duration-300",
        minimal: "bg-muted text-muted-foreground hover:bg-muted/80 border border-border",
        hero: "bg-gradient-hero text-white hover:shadow-glow transition-all duration-300 shadow-xl text-base font-semibold",
      },
      size: {
